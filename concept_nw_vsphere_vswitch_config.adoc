...
[cols="5*"]
|===
| Gruppo di porte | Esterni 1 | Esterni 2 | Interno 1 | Interno 2 
...
*Parte 1: Configurazioni dei gruppi di porte esterne ONTAP Select*

image:DDN_09.jpg["Parte 1: Configurazioni del gruppo di porte esterne ONTAP Select"]
