...
. Dopo che la VM è stata distribuita, seleziona la nuova VM e accendila se non è già accesa in base al tuo input nella procedura guidata di distribuzione.
