...
. Fare clic image:icon_kebab.gif["Opzioni"]sulla destra del cluster e selezionare *Take Offline*.
+
...
. Per riportare il cluster online, fare clic su image:icon_kebab.gif["Opzioni"] e selezionare *Bring Online*.
...
. Accedere all'interfaccia utente Web dell'utilità di implementazione utilizzando l'account amministratore.
. Fare clic sulla scheda *Clusters* nella parte superiore della pagina e selezionare il cluster desiderato dall'elenco.
. Fare clic image:icon_kebab.gif["Opzioni"]sulla destra del cluster e selezionare *Elimina*.
+
...
. Fare clic image:icon_kebab.gif["Opzioni"]sul lato destro della pagina e selezionare *Cluster Refresh* (aggiornamento cluster).
