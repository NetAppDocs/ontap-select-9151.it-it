...
Per ulteriori informazioni su come configurare Open vSwitch su un host hypervisor, consultare il link:https://www.netapp.com/media/13134-tr4613.pdf["Architettura e Best practice del prodotto ONTAP Select su KVM"^]report tecnico.
