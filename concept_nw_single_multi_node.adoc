...
Le porte ONTAP e0a, e0b e e0c sono delegate come porte candidate per le LIF che trasportano i seguenti tipi di traffico:
...
Le porte ONTAP e0a, e0b e e0g sono delegate come porte candidate per le LIF che trasportano i seguenti tipi di traffico:
...
Per ulteriori informazioni, vedere la sezione link:reference_plan_best_practices.html#two-node-stretched-ha-metrocluster-sds-best-practices["Best practice di ha (MetroCluster SDS) con due nodi estesi"].
