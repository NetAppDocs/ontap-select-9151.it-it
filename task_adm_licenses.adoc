...
. Per sostituire una licenza esistente, selezionare una licenza, fare clic su image:icon_kebab.gif["Opzioni"], quindi selezionare *Aggiorna*.
...
+
Per ulteriori informazioni, vedere link:task_lic_acquire_cp.html["Acquisire una licenza per pool di capacità"] .
