...
....
+
Il `<ip_address>` parametro è l'indirizzo IP della nuova macchina virtuale di distribuzione.
...
. Fare clic su *modello* accanto a `iscsi_target` e completare il valore del nome.
+
